...
const CreateCourseForm: React.FC<{}> = () => {
  ...
  const { createCourse, erroR, isLoading } = useCreateCourseForm();
    ...
    <>
      <div className={containerClass}>
        <div className={formWrapperClass}>
          ...
          <Formik initialValues={initialValues} onSubmit={(data) => createCourse(data)} validationSchema={validationSchema}>
            <Form className="space-y-4">
              ...
              {isLoading ? (
                <button className="btn btn-primary w-full mt-4 loading">Створюється...</button>
              ) : (
